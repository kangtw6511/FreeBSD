...
pkg install -y sudo nano xorg firefox ko-nanumfonts noto-kr lightdm-gtk-greeter xfce xfce4-goodies dbus fcitx5-gtk fcitx5-configtool ko-fcitx5-hangul wifimgr dsbmixer
...
# Add /proc filesystem to /etc/fstab if it is not already there
